...
namespace CLGT {
    ...
    static CLGTReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "aW5fdHlwZRgBIAEoBRINCgV0b2tlbhgCIAEoCSKtBQoITG9naW5BY2sSDwoH",
            ...
            "FgoOb3Blbl90aW1lc3RhbXAYGCABKAcSGgoSYmFua19wYXNzd29yZF9mbGFn",
            "GBkgASgIEhUKDWJhbmtfY3VycmVuY3kYGiABKAMSFAoMbGFzdF9nYW1lX2lk",
            "GBsgASgFEhQKDGxhc3Rfcm9vbV9pZBgcIAEoBRIQCghoZWFkX3VybBgdIAEo",
            "CRIRCgltYXhfc3RhcnQYHiABKAUSGQoRYWdlbnRfc2VydmVyX2xpc3QYHyAD",
            "KAkSFgoOZ2FtZV9raW5kX2xpc3QYICADKAUSDQoFc3RhdGUYISABKAgiQgoQ",
            "RW1haWxTZW5kQ29kZVJlcRIOCgZpbnRlbnQYASABKAUSDwoHaGFpX3dhaRgC",
            "IAEoCBINCgVlbWFpbBgDIAEoCSIjChBFbWFpbFNlbmRDb2RlQWNrEg8KB2Vy",
            "cmNvZGUYASABKAUiRgoQUGhvbmVTZW5kQ29kZVJlcRIOCgZpbnRlbnQYASAB",
            "KAUSDQoFcGhvbmUYAiABKAkSEwoLc21zX2NoYW5uZWwYAyABKAUiIwoQUGhv",
            "bmVTZW5kQ29kZUFjaxIPCgdlcnJjb2RlGAEgASgFIicKFENoZWNrQWNjb3Vu",
            "dEV4aXN0UmVxEg8KB2FjY291bnQYASABKAkiOQoUQ2hlY2tBY2NvdW50RXhp",
            "c3RBY2sSDwoHZXJyY29kZRgBIAEoBRIQCghpc19leGlzdBgCIAEoCCKoAQoS",
            "QWNjb3VudFJlZ2lzdGVyUmVxEg8KB2FjY291bnQYASABKAkSEAoIcGFzc3dv",
            "cmQYAiABKAkSDQoFcGhvbmUYAyABKAkSDQoFZW1haWwYBCABKAkSDAoEY29k",
            "ZRgFIAEoCRIQCghwbGF0Zm9ybRgGIAEoBRIOCgZkZXZpY2UYByABKAkSDwoH",
            "Y2hhbm5lbBgIIAEoBRIQCghuaWNrbmFtZRgJIAEoCSJqChJBY2NvdW50UmVn",
            "aXN0ZXJBY2sSDwoHZXJyY29kZRgBIAEoBRIPCgd1c2VyX2lkGAIgASgFEhAK",
            "CG5pY2tuYW1lGAMgASgJEgwKBGhlYWQYBCABKAUSEgoKaGVhZF9mcmFtZRgF",
            "IAEoBSJsChdBY2NvdW50UmVzZXRQYXNzd29yZFJlcRIPCgdhY2NvdW50GAEg",
            "ASgJEhQKDG5ld19wYXNzd29yZBgCIAEoCRINCgVwaG9uZRgDIAEoCRINCgVl",
            "bWFpbBgEIAEoCRIMCgRjb2RlGAUgASgJIioKF0FjY291bnRSZXNldFBhc3N3",
            "b3JkQWNrEg8KB2VycmNvZGUYASABKAUiDgoMS2VlcEFsaXZlUmVxIh8KDEtl",
            "ZXBBbGl2ZUFjaxIPCgdlcnJjb2RlGAEgASgFIhUKE1Rlc3ROZXRJbnRlcnJ1",
            "cHRScHRiBnByb3RvMw=="));
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "open_timestamp" field.</summary>
    public const int OpenTimestampFieldNumber = 24;
    private uint openTimestamp_;
    /// <summary>
    ///账号解封时间或系统开放时间戳，空串代表永久
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public uint OpenTimestamp {
    ...
    public override int GetHashCode() {
      ...
      if (OpenTimestamp != 0) hash ^= OpenTimestamp.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (OpenTimestamp != 0) {
        ...
        output.WriteFixed32(OpenTimestamp);
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 197: {
            OpenTimestamp = input.ReadFixed32();
            break;
          }
          case 200: {
